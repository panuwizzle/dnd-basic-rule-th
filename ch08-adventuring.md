...
#### กิจกรรมอื่น ๆ
ตัวละครที่ไปสนใจทำอย่างอื่นขณะเดินทางจะไม่ได้ระวังอันตรายที่อาจจะเกิดขึ้น ตัวละครเหล่านี้จะไม่ถูกนำคะแนนการหยั่งรู้แบบเบื้องหลัง [passive wisdom (perception)] มาใช้ อย่างไรก็ตาม ตัวละครที่ไม่ได้คอยเฝ้าระวังสามารถทำกิจกรรมอื่น ๆ เหล่านี้ได้แทนหาก DM อนุญาต
