...
| -------- | ------------------- | ----------------- | ---------------- | -------------------------------------------------------- |
| เร็ว     | 400 ฟุต             | 4 ไมล์            | 30 ไมล์          | ลดค่าการหยั่งรู้แบบเบื้องหลัง (passive Perception) ลง -5 |
...
การลอบโจมตี (surprise attack) หากนักผจญภัยเจอกับมอนสเตอร์ที่เป็นภัยหรือกลุ่มคน DM อาจกำหนดให้นักผจญภัยหรือศัตรูสามารถเริ่มการโจมตีแบบลอบเข้าโจมตีได้ ดูส่วนของ [การศึก](./ch09-combat.md) เพิ่มเติมสำหรับกฏการโจมตีแบบลอบโจมตี
