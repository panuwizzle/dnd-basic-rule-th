...
layout: page
title:  "บทนำ"
#permalink: /basic-rules/introduction
---
# บทนำ
...
Part 4 is especially for the ดันเจี้ยนมาสเตอร์ . It contains instructions for how to challenge the player characters with adversaries that are a good test of their abilities, plus dozens of ready-to-use monster descriptions. It also provides a sampling of magic items that the characters can earn as their rewards for vanquishing those monsters.
