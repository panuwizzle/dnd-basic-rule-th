...
ตัวละครแต่ละตัวจะเป็นหนึ่งในเผ่าพันธุ์ทรงปัญญารูปร่างแบบมนุษย์ (humanoid) ที่มีในโลกของ D&D เผ่าพันธุ์ส่วนใหญ่ก็จะมี [ดวอร์ฟ - คนแคระ](./ch02-races#dwarf), [เอลฟ์](./ch02-races#elf), [ฮาล์ฟลิง](./ch02-races#halfling) และ[มนุษย์](./ch02-races#human) บางเผ่าพันธุ์จะมีเผ่าพันธุ์ย่อย (ซับเรช - subraces) เช่นคนแคระภูเขา (mountain dwarf) เอลฟ์ป่า (วู๊ดเอลฟ์ - wood elf) บทที่ 2 [เผ่าพันธุ์](./ch02-races) จะมีข้อมูลของเผ่าพันธุ์เหล่านี้
...
นักผจญภัยทุกคนจะมีอาชีพของตัวเอง อาชีพเรียกได้ว่า คลาส จะบอกทักษะพิเศษที่เขาหรือเธอมีรวมถึงแทคติกที่จะใช้ในการตระเวณดันเจียน สู้กับมอนสเตอร์ หรือการเจรจาต่อรอง คลาสของตัวละครมีรายละเอียดในส่วนของ [คลาส](./ch03-classes)
