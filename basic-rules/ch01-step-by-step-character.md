...
ตัวละครแต่ละตัวจะเป็นหนึ่งในเผ่าพันธุ์ทรงปัญญารูปร่างแบบมนุษย์ (humanoid) ที่มีในโลกของ D&D เผ่าพันธุ์ส่วนใหญ่ก็จะมี [ดวัร์ฟ - คนแคระ](./races/dwarf.md), [เอลฟ์](./races/elf.md), [ฮาล์ฟลิง](./ch02-races.md#halfling) และ[มนุษย์](./races/human.md) บางเผ่าพันธุ์จะมีเผ่าพันธุ์ย่อย (ซับเรช - subraces) เช่นคนแคระภูเขา (mountain dwarf) เอลฟ์ป่า (วู๊ดเอลฟ์ - wood elf) บทที่ 2 [เผ่าพันธุ์](./ch02-races.md) จะมีข้อมูลของเผ่าพันธุ์เหล่านี้
