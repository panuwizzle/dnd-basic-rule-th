...
---
# [บทที่ 1: สร้างตัวละครทีละขั้น](#step-by-step)
...
ตัวละครแต่ละตัวจะเป็นหนึ่งในเผ่าพันธุ์ทรงปัญญารูปร่างแบบมนุษย์ (humanoid) ที่มีในโลกของ D&D เผ่าพันธุ์ส่วนใหญ่ก็จะมี [ดวอร์ฟ - คนแคระ](../races/dwarf), [เอลฟ์](../races/elf), [ฮาล์ฟลิง](../races/halfling) และ[มนุษย์](../races/human) บางเผ่าพันธุ์จะมีเผ่าพันธุ์ย่อย (ซับเรช - subraces) เช่นดวอร์ฟภูเขา (mountain dwarf) เอลฟ์ป่า (วู๊ดเอลฟ์ - wood elf) บทที่ 2 [เผ่าพันธุ์](/basic-rules/ch02-races) จะมีข้อมูลของเผ่าพันธุ์เหล่านี้
