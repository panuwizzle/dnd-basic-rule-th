...
## การทอยแบบได้เปรียบและแบบเสียเปรียบ (Adventage and Disadvantage) {#advantage-disadvantage}
...
##### ทักษะกายกรรม [Acrobatics: อะโครแบติกส์] {#acrobatics}  
...
##### ทักษะมือไว [Sleight of Hand: สไลท์ ออฟ แฮนด์] {#sleight-of-hand}  
...
##### ทักษะลอบเร้น [Stealth: สเต็ลธ์] {#stealth}  
...
##### ทักษะด้านตำนาน [Arcana: อาร์คาน่า] {#arcana}
...
##### ทักษะด้านประวัติศาสตร์ [History: ฮิสทอรี่] {#history}
...
##### ทักษะการสืบสวน [Investigation: อินเวสติเกชัน] {#investigation}
...
##### ทักษะความรู้ทางธรรมชาติ [Nature: เนเจอร์] {#nature}
...
##### ความรู้ทางศาสนา [Religion: รีลิเจียน] {#religion}
...
##### ทักษะการจัดการสัตว์ (Animal Handling) {#animal-handling}
...
##### ทักษะการมองทะลุ (Insight) {#insight}
...
##### ทักษะการเอาตัวรอด (Survival) {#survival}
...
##### ทักษะการหลอกลวง (Deception) {#deception}
...
##### ทักษะการข่มขู่ (Intimidation) {#intimidation}
...
##### ทักษะการแสดง (Performance) {#performance}
...
##### ทักษะการโน้มน้าว (Persuasion) {#persuasion}
...
## การทอยป้องกัน (Saving Throws) {#saving-throw}
