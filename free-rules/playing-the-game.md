...
An adventure might be created by the Dungeon Master or purchased (the examples of play in this chapter are inspired by a published adventure, [Curse of Strahd](/cos)). In either case, an adventure features a fantastic setting, such as an underground dungeon, a wondrous wilderness, or a magic-filled city. It includes a cast of nonplayer characters controlled by the DM. Often one of the NPCs is a villain whose agenda drives much of an adventure’s action.
...
Each ability has a modifier that you apply whenever you make a [D20 Test](/free-rules/rules-glossary#D20Test) with that ability (explained in “[D20 Tests](#D20Tests)”). An ability modifier is derived from its score, as shown in the Ability Modifiers table.
...
Add your Proficiency Bonus to an ability check when the DM determines that a skill or tool proficiency is relevant to the check and you have that proficiency. For example, if a rule refers to a Strength ([Acrobatics](#Skills) or [Athletics](#Skills)) check, you can add your Proficiency Bonus to the check if you have proficiency in the [Acrobatics](#Skills) or [Athletics](#Skills) skill. See “[Proficiency](/free-rules/playing-the-game#Proficiency)” later in this chapter for more information about skill and tool proficiencies.
...
If a creature is proficient in a skill, the creature applies its Proficiency Bonus to ability checks involving that skill. Without proficiency in a skill, a creature can still make ability checks involving that skill but doesn’t add its Proficiency Bonus. For example, if a character tries to climb a cliff, the DM might ask for a Strength ([Athletics](#Skills)) check. If the character has [Athletics](#Skills) proficiency, the character adds their Proficiency Bonus to the Strength check. If the character lacks that proficiency, they make the check without adding their Proficiency Bonus.
...
>
> Each skill proficiency is associated with an ability check. For example, the [Intimidation](#Skills) skill is associated with Charisma. In some situations, the DM might allow you to apply your skill proficiency to a different ability check. For example, if a character tries to intimidate someone through a show of physical strength, the DM might ask for a Strength ([Intimidation](#Skills)) check rather than a Charisma ([Intimidation](#Skills)) check. That character would make a Strength check and add their Proficiency Bonus if they have [Intimidation](#Skills) proficiency.
...
See [chapter 6](/free-rules/equipment) for rules on many items that are useful on adventures. The items in that chapter’s “[Tools](/free-rules/equipment#Tools)” and “[Adventuring Gear](/free-rules/equipment#AdventuringGear)” sections are especially useful. The weapons in that chapter can also be used for more than battle; you could use a [Quarterstaff](), for example, to push a sinister-looking button that you’re reluctant to touch.
...
An area might be Lightly or Heavily Obscured. In a Lightly Obscured area—such as an area with Dim Light, patchy fog, or moderate foliage—you have [Disadvantage](/free-rules/rules-glossary#Disadvantage) on Wisdom ([Perception](#Skills)) checks that rely on sight.
...
When your character searches for hidden things, such as a secret door or a trap, the DM typically asks you to make a Wisdom ([Perception](#Skills)) check, provided you describe the character searching in the hidden object’s vicinity. On a success, you find the object, other important details, or both.

If you describe your character searching nowhere near a hidden object, a Wisdom ([Perception](#Skills)) check won’t reveal the object, no matter the check’s total.
...
**_Fast._** Traveling at a Fast pace imposes [Disadvantage](/free-rules/rules-glossary#Disadvantage) on a traveler’s Wisdom ([Perception](#Skills) or [Survival](#Skills)) and Dexterity ([Stealth](#Skills)) checks.

**_Normal._** Traveling at a Normal pace imposes [Disadvantage](/free-rules/rules-glossary#Disadvantage) on Dexterity ([Stealth](#Skills)) checks.

**_Slow._** Traveling at a Slow pace grants [Advantage](/free-rules/rules-glossary#Advantage) on Wisdom ([Perception](#Skills) or [Survival](#Skills)) checks.
...
#### [Range](/free-rules/playing-the-game#Range)
...
#### [Ranged Attacks in Close Combat](/free-rules/playing-the-game#RangedAttacksinCloseCombat)
...
### [Melee Attacks](/free-rules/playing-the-game#MeleeAttacks)
...
#### [Reach](/free-rules/playing-the-game#Reach)
...
#### [Opportunity Attacks](/free-rules/playing-the-game#OpportunityAttacks)
...
#### [Mounting and Dismounting](/free-rules/playing-the-game#MountingandDismounting)
...
#### [Controlling a Mount](/free-rules/playing-the-game#ControllingaMount)
...
#### [Falling Off](/free-rules/playing-the-game#FallingOff)
...
#### [Impeded Weapons](/free-rules/playing-the-game#ImpededWeapons)
...
#### [Fire Resistance](/free-rules/playing-the-game#FireResistance)
...
### [Critical Hits](/free-rules/playing-the-game#CriticalHits)
...
### [Saving Throws and Damage](/free-rules/playing-the-game#SavingThrowsandDamage)

Damage dealt via saving throws uses these rules.

#### [Damage against Multiple Targets](/free-rules/playing-the-game#DamageagainstMultipleTargets)
...
#### [Half Damage](/free-rules/playing-the-game#HalfDamage)
...
### [Damage Types](/free-rules/playing-the-game#DamageTypes)
...
### [Resistance and Vulnerability](/free-rules/playing-the-game#ResistanceandVulnerability)
...
#### [No Stacking](/free-rules/playing-the-game#NoStacking)
...
#### [Order of Application](/free-rules/playing-the-game#OrderofApplication)
...
### [Immunity](/free-rules/playing-the-game#Immunity)
...
### [Healing](/free-rules/playing-the-game#Healing)
...
### [Dropping to 0 Hit Points](/free-rules/playing-the-game#Droppingto0HitPoints)
...
#### [Instant Death](/free-rules/playing-the-game#InstantDeath)
...
#### [Character Demise](/free-rules/playing-the-game#CharacterDemise)
...
#### [Falling Unconscious](/free-rules/playing-the-game#FallingUnconscious)
...
#### [Stabilizing a Character](/free-rules/playing-the-game#StabilizingaCharacter)
...
### [Temporary Hit Points](/free-rules/playing-the-game#TemporaryHitPoints)
...
#### [Lose Temporary Hit Points First](/free-rules/playing-the-game#LoseTemporaryHitPointsFirst)
...
#### [Duration](/free-rules/playing-the-game#Duration)
...
#### [Temporary Hit Points Don’t Stack](/free-rules/playing-the-game#TemporaryHitPointsDontStack)
...
#### [They’re Not Hit Points or Healing](/free-rules/playing-the-game#TheyreNotHitPointsorHealing)
...
## [Conditions](/free-rules/playing-the-game#Conditions)
...
### [Duration](/free-rules/playing-the-game#ConditionDuration)
...
### [Conditions Don’t Stack](/free-rules/playing-the-game#ConditionsDontStack)
